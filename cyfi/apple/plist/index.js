...
const link = (name) => `https://webcache.googleusercontent.com/search?q=cache:B0lrczd-p78J:https://developer.apple.com/documentation/bundleresources/information_property_list/${name}`
...
const markdown = () => {
    ...
    return Object.keys(obj).forEach(async (name) => {
        ...
        fs.writeFile("README.md", mardownEl,
            {
                encoding: "utf8",
                flag: "a",
            },
        ...
        fs.writeFile(`docs/${name}.md`, mardownEl + "```json \n" + JSON.stringify(docs, null, 4) + "\n```",
            {
                encoding: "utf8",
                flag: "w",
            },
        ...
        fs.writeFile(`json/${name}.json`, JSON.stringify(docs, null, 4),
            {
                encoding: "utf8",
                flag: "w",
            },
