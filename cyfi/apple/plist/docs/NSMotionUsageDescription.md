...
```json 
{
    "id": 3041020,
    "title": {
        "content": "NSMotionUsageDescription"
    },
    "abstract": "<div><p>A message that tells the user why the app is requesting access to the device&#8217;s accelerometer.</p></div>",
    "discussion": "<div><aside class=\"aside aside-important\" aria-label=\"important\"><p class=\"aside-name\">Important</p><p>This key is required if your app uses APIs that access the device&#8217;s accelerometer.</p></aside><p></p></div>",
    "containingGroup": [
        {
            "id": 3112338,
            "role": "task",
            ...
            "symbols": [
                {
                    "id": 3041020,
                    "role": "symbol",
                    "usr": "plist:Information_Property_List.NSMotionUsageDescription",
                    ...
                    "xcodeTitle": "Privacy - Motion Usage Description",
                    "displayName": "<code class=\"display-name\"><span class=\"label\">property list key </span><span class=\"identifier\">NSMotion<wbr/>Usage<wbr/>Description</span></code>",
                    "titleStyle": "symbol",
                    "paths": [
                        "documentation/bundleresources/information_property_list/nsmotionusagedescription"
                    ],
                    "title": {
                        "content": "NSMotionUsageDescription"
                    },
    ...
    "declaration": [
        {
            "content": "<span>string NSMotionUsageDescription\n</span>",
            "platforms": [
                "iOS",
                "macOS"
            ],
