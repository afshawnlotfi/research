...
```json 
{
    ...
    "discussion": "<div><p>Xcode automatically includes this key in the WatchKit extension&#8217;s information property list and sets its value to <code class=\"code-voice\"><span>YES</span></code> when you create a project using the iOS App with Watch App template. When you set the value of this key to <code class=\"code-voice\"><span>YES</span></code>, the app doesn&#8217;t need its iOS companion app to operate properly. Users can choose to install the iOS app, the watchOS app, or both.</p></div>",
    "containingGroup": [
        {
            "id": 3167157,
            "role": "task",
    ...
    "declaration": [
        {
            "content": "<span>boolean WKRunsIndependentlyOfCompanionApp\n</span>",
            "platforms": [
                "watchOS"
            ],
            "allowedTypesDetails": [
