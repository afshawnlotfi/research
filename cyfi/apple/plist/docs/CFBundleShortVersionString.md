...
```json 
{
    ...
    "discussion": "<div><p>This key is a user-visible string for the version of the bundle. The required format is three period-separated integers, such as 10.14.1. The string can only contain numeric characters (0-9) and periods.</p><p>Each integer provides information about the release in the format [<em>Major</em>].[<em>Minor</em>].[<em>Patch</em>]:</p><ul><li><p>Major: A major revision number.</p></li><li><p>Minor: A minor revision number.</p></li><li><p>Patch: A maintenance release number.</p></li></ul><p>This key is used throughout the system to identify the version of the bundle.</p></div>",
    "seeAlso": [
        {
            "id": 3040956,
            "role": "symbol",
    ...
    "declaration": [
        {
            "content": "<span>string CFBundleShortVersionString\n</span>",
            "platforms": [
                "iOS",
                "macOS",
                "tvOS",
