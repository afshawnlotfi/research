# [UIApplicationExitsOnSuspend](http://webcache.googleusercontent.com/search?q=cache:https://developer.apple.com/documentation/bundleresources/information_property_list/UIApplicationExitsOnSuspend)
## Application does not run in background
### A Boolean value indicating whether the app terminates, rather than moves to the background, when the app quits.
### [Default]: false
### [JSON](../json/UIApplicationExitsOnSuspend.json)
```json 
{
    "id": 3040971,
    "title": {
    ...
    "deprecationSummary": "<div><p>The system now automatically suspends apps leaving the foreground when they don&#8217;t require background execution. For more information, see <a href=\"/documentation/uikit/app_and_environment/scenes/preparing_your_ui_to_run_in_the_background/about_the_background_execution_sequence\">About the Background Execution Sequence</a>.</p></div>",
    "containingGroup": [
        {
            "id": 3375069,
            "role": "task",
    ...
    "declaration": [
        {
            "content": "<span>boolean UIApplicationExitsOnSuspend\n</span>",
            "platforms": [
                "iOS",
                "tvOS",
                "watchOS"
