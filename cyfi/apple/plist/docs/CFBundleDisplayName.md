...
```json 
{
    ...
    "discussion": "<div><p>Use this key if you want a product name that&#x27;s longer than <a class=\"symbol-name\" href=\"/documentation/bundleresources/information_property_list/cfbundlename\"><code><span>CFBundle<wbr/>Name</span></code></a>.</p></div>",
    ...
    "declaration": [
        {
            "content": "<span>string CFBundleDisplayName\n</span>",
            "platforms": [
                "iOS",
                "macOS",
                "tvOS",
